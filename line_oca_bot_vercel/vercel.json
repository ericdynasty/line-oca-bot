...
// ---- 環境變數（到 Vercel 專案 Settings → Environment Variables 設定） ----
// LINE_CHANNEL_ACCESS_TOKEN
// LINE_CHANNEL_SECRET （此版先不做簽章驗證，可先留空）
...
export default async function handler(req, res) {
  ...
  try {
    ...
    res.status(200).send('OK'); // LINE 需要 200
  } catch (err) {
